...
<main id="primary" class="row site-main">
	...
	<section class="col-12 col-md-4 m-md-auto error-404 not-found">
		<header class="page-header text-center">
			...
			<h1 class="page-title"><?php esc_html_e('Você não tem acesso a este recurso', 'polen'); ?></h1>
		</header><!-- .page-header -->

		<div class="page-content text-center mt-4">
			<p><?php esc_html_e('Você não tem acesso a este recurso, verifique sua conta ou entre em ajuda.', 'polen'); ?></p>
