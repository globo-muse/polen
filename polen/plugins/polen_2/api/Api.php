...
use Polen\Api\v2\{Api_Polen_Cases, Api_Polen_Contact, Api_Polen_FAC, Api_Polen_FAQ, Api_Polen_Home, Api_Polen_Pages, Api_Polen_Products};
...
class Api {
    ...
    public function rest_api_includes() {
        if ( empty( WC()->cart ) ) {
            ...
            (new Api_Polen_Contact())->register_route();
            (new Api_Polen_Pages())->register_route();
            (new Api_Polen_Cases())->register_route();
        }
    }
